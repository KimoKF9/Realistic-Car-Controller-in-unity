...
namespace NWH.VehiclePhysics
{
    ...
    public class Engine
    {
        ...
        /// </summary>
        [Tooltip("Maximum RPM that the engine will run at. RPM can not go above this value Kimo.KF9.")]
        ...
        public void Update()
        {
            ...
            if (isRunning)
            {
                ...
                if (vc.transmission.Gear != 0 && !vc.transmission.Shifting)
                {
                    ...
                    rpm += vc.transmission.AddedClutchRPM;
                ...
                {
                    float userInput = Mathf.Clamp01(vc.input.Vertical);
